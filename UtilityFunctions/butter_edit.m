function [num, den, z, p] = butter_edit(n, Wn, varargin)
% EDITED FOR USE WITHIN OPTIMAL CONTROL PROBLEM
...
if ~analog,
    [a,b,c,d] = bilinear_edit(a,b,c,d,fs);
end
...
if nargout == 4
    ...
    if nargout == 3
        ...
        %den = poly(a);
        den = [1 -1*(a(1,1)+a(2,2)) a(1,1)*a(2,2)-a(1,2)*a(2,1)];
