function [] = predictiveSprintingSimulations_v4()
...
% Lower optimum fiber length
%muscProperties(2,[1:9,14:16,19:22,25:27]) = muscProperties(2,[1:9,14:16,19:22,25:27]).*0.95;
...
% % % % for iik = 1:37
% % % %     plot(guess1.q(:,iik),'LineWidth',2,'Color','b');
% % % %     hold on
% % % %     plot(bounds_sc1.q.lower(iik,:),'LineWidth',2,'Color','r');
% % % %     plot(bounds_sc1.q.upper(iik,:),'LineWidth',2,'Color','r');
% % % %     waitfor(gcf);
% % % % end
...
if Options.WarmStart == 'Y'
    options.ipopt.warm_start_init_point = 'yes';
    options.ipopt.warm_start_bound_push = 1e-16; % Default is 0.001
    options.ipopt.warm_start_bound_frac = 1e-16; % 0.001
    options.ipopt.warm_start_slack_bound_frac = 1e-16; % 0.001
    options.ipopt.warm_start_slack_bound_push = 1e-16; % 0.001
    options.ipopt.warm_start_mult_bound_push = 1e-16; % 0.001
...
% Solve the NLP
if Options.WarmStart == 'N'
    sol = solver('x0',w0,'lbx',lbw','ubx',ubw','lbg',lbg,'ubg',ubg);
elseif Options.WarmStart == 'Y' && Options.prevSol == 'Y'
    sol = solver('x0',w0,'lbx',lbw','ubx',ubw','lbg',lbg,'ubg',ubg,'lam_x0',prevSol.optimumOutput.lam_x_opt,'lam_g0',prevSol.optimumOutput.lam_g_opt);
end
w_opt = full(sol.x);
stats = solver.stats;
